...
parser.add_argument('--net_type', default='pyramidnet', type=str,
                    help='networktype: resnet, pyramidnet, and vit')
...
def main():
    ...
    writer = SummaryWriter(log_dir=f'runs/{args.expname}')
    ...
    if args.dataset.startswith('cifar'):
        ...
        transform_train = transforms.Compose([
            transforms.RandomResizedCrop(224),  # 修改尺寸以适应ViT
        ...
        transform_test = transforms.Compose([
            transforms.Resize(224),  # 修改尺寸以适应ViT
            transforms.ToTensor(),
            normalize
        ])
    ...
    for epoch in range(0, args.epochs):
        ...
        writer.add_scalar('Accuracy/top1', 100 - err1, epoch)
        writer.add_scalar('Accuracy/top5', 100 - err5, epoch)
